---
name: sdlc:research
description: Market and competitive research, customer voice analysis, and gap identification. Outputs to branch-scoped artifacts (update, never recreate).
...
Outputs (always update existing, never recreate):
  - .claude/ai-sdlc/workflows/<branch>/artifacts/research/research.md — market landscape, trends, competitors
  - .claude/ai-sdlc/workflows/<branch>/artifacts/research/gap-analysis.md — customer pain points, unmet needs, opportunities
