...
Output (update existing, never recreate):
  - docs/research/VOC.md — themed findings with verbatim evidence, frequency counts, severity ratings
  - docs/research/GAP_ANALYSIS.md — enriched with primary-source evidence (update existing gaps with quotes)
