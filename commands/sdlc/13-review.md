...
<auto_verify>
When all workflow steps above are complete, immediately run the Phase 13 verification checklist from the verify workflow — without waiting for user instruction. Do not ask. Output the full verification result before finishing.
</auto_verify>
